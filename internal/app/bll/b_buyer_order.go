...
type IBuyerOrder interface {
	...
	// 创建数据
	Create(ctx context.Context, item schema.BuyerOrder) (*schema.BuyerOrder, error)
	// 更新数据
	Update(ctx context.Context, recordID string, item schema.BuyerOrder) (*schema.BuyerOrder, error)
	// 删除数据
